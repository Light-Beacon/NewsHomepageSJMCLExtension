...
const launcherExtensionsRoot = path.join(process.env.HOME, "Library/Application Support/SJMCL/UserContent/Extensions");
...
async function main() {
  ...
  const outputDirectory = path.join(launcherExtensionsRoot, manifest.identifier);
