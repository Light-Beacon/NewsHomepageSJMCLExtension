...
function renderInline(
	...
	return nodes.map(function (node, index) {
		...
		if (node.type === "code") {
			return React.createElement(Code, { key, fontSize: "0.90em" }, node.value);
		}
...
function renderListNode(
	...
	return React.createElement(ListComponent, { key: keyPrefix, ps: 4, mb: 1 }, ...items);
}
